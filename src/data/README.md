...
Il campo `users` puo esistere solo come array vuoto per compatibilita con snapshot storici. Le migrazioni lo svuotano e i salvataggi Firestore lo riscrivono sempre vuoto.
